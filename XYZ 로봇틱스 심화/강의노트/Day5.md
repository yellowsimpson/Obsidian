...
5.3.3 공부해올것!!
## 5.3.3 오일러 각 알아보기
오일러각이란? 물체의 방향을 서로 수직인 x,y,z축의 각도로 표현하는 방법 중 하나입니다. 이때 a,b,c는 순차적인 회전 각도를 의미합니다. 
...
# 5.9 Task Editor 모듈
pg225
![[스크린샷 2025-10-10 오후 1.45.49.png]]
...
## 5.9.1 Task Editor Move Command 기본 개념 알아보기
...
3일 정도 전체적인 프로세스를 만들어야되!!
.drl
업무 분담
기능 구현

intigration을 매일매일 해야함
일단 이해를 잘 해야함
자기 인식을 잘 해야함
...
스텍
버퍼의 종류
리스트와 배열의 자료구조는 어떻게 되 있을까?
항상 배우고 새롭게 시작한다고 생각
머리 똑똑한 사람이 아니라 성실하게 대하는 사람이 승리한다!!
...
패키지를 만들때는 대규모 프로젝트
폴더 이름이 패키지이름!!
![[스크린샷 2025-10-10 오후 7.47.21.png]]
